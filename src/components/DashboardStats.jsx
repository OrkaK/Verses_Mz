    ...
    <div className="flex flex-col gap-6 animate-fade-in">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
        ...
        <div className="card p-4 flex flex-col justify-between">
          ...
          <div className="flex items-baseline justify-between">
            <span className="text-2xl font-bold" style={{ color: '#C87D55' }}>{learningCount}</span>
            <BrainCircuit size={18} style={{ color: '#C87D55' }} />
          </div>
        </div>
      ...
      <div className="card flex flex-col gap-4">
        <div className="flex items-center justify-between border-b border-subtle pb-3">
          <div className="flex items-center gap-2">
            <Sparkles size={20} style={{ color: '#C87D55' }} />
      ...
      <div className="flex flex-col gap-3">
        <h3 className="serif-heading text-lg flex items-center gap-2">
          <Gamepad2 size={20} style={{ color: '#C87D55' }} /> Practice Games & Modes
        </h3>
