      ...
      <div className="hidden md:flex flex-col gap-4 mb-6 px-2">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-3">
            <div className="w-10 h-10 rounded-lg bg-terracotta flex items-center justify-center text-white shadow-sm" style={{ backgroundColor: '#C87D55' }}>
        ...
        <div className="flex items-center justify-between p-3 rounded-lg border bg-secondary/50 border-subtle">
          <div className="flex items-center gap-2">
            <Flame size={20} style={{ color: '#C87D55' }} />
            <div>
        ...
        <button
          ...
          style={{ width: '100%', backgroundColor: '#C87D55' }}
        >
