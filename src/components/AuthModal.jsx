      ...
      >
        ...
        <div className="flex items-center justify-between pb-3 border-b border-subtle">
          <div className="flex items-center gap-2">
            <Cloud size={20} style={{ color: '#C87D55' }} />
        ...
        {user ? (
          ...
          <div className="flex flex-col gap-5">
            <div className="p-4 rounded-xl border border-subtle bg-secondary/30 flex items-center gap-3">
              <div className="w-12 h-12 rounded-full bg-terracotta text-white flex items-center justify-center font-bold text-lg shadow-sm" style={{ backgroundColor: '#C87D55' }}>
                {user.avatar || 'U'}
              </div>
